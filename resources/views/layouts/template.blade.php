...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">Portfolio Web</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="assets/img/yo3.jpg" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Ivan Kolarik</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Desarrollador FullStack - Movile Developer - QAAnalyst</p>
        </div>
    </header>
    <!-- Portfolio Section-->
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Stack Tecnologico</h2>
            <!-- Icon Divider-->
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a class="btn btn-xl btn-outline-light" href="https://drive.google.com/file/d/1CYCG4rbaoQO_wWrULh01tKDnzLC-kLZG/view?usp=sharing" target="_blank">
                ...
                <div class="col-lg-8 col-xl-7">
                    ...
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <div class="invalid-feedback" data-sb-feedback="name:required">nombre y apellido</div>
                        </div>
                        <!-- Email address input-->
                        <div class="form-floating mb-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-3 mb-5 mb-lg-0">
                    <h4 class="text-uppercase mb-4">Wathsapp</h4>
                    <div id="whatsapp">
                ...
                <!-- Footer Social Icons-->
                <div class="col-3 mb-5 mb-lg-0 text-center">
